...
return [
    'rate_not_found' => 'No POS rate found matching the given criteria.',
    'rate_not_found_with_filters' => 'No POS rate found matching the given criteria. Filters: [:filters]',
    'pos_rate_api_error' => 'Failed to fetch POS rates from the external API.',
